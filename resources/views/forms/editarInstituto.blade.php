    ...
    <div class="mt-20 space-y-10">
        ...
        <x-bladewind::card>
            <div class="flex justify-between items-center">
                <h1 class="uppercase text-gray-500"><i class="bi-collection-fill"></i> Institutos > Editar </h1>
        ...
        <x-bladewind::card>
            <form action="/institutos/atualizar" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf

                <input type="hidden" value="{{ $instituto->id }}" name='id'>
                <!-- Nome -->
                <div>
                    ...
                    <div class="flex items-center border border-slate-300 rounded">
                        ...
                        <input type="text" id="any-text" name="nome" maxlength="50" required
                            value="{{ $instituto->nome }}" pattern="^[A-Za-zÀ-ÿ\s]{3,50}$" class="{{ $class_input }}"
                ...
                <div>
                    ...
                    <div class="flex items-center border border-slate-300 rounded">
                        ...
                        <input type="email" id="any-email" name="email" class="{{ $class_input }}"
                            value="{{ $instituto->email }}" placeholder="example@email.com">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center border border-slate-300 rounded">
                        ...
                        <input type="text" maxlength="10" name="nif" pattern="^\d{10}$" required
                            value="{{ $instituto->nif }}" class="{{ $class_input }}"
                            placeholder="4367820363..(apenas 10 caracteres)">
                    </div>
                </div>
