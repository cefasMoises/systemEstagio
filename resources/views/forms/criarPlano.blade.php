...
@section('content')
    ...
    <div class="mt-20 space-y-10">
        ...
        <x-Title-App title="planos > registrar" icon="bi bi-journal" type='secondary' action="/planos" text-action='voltar' />


        @if (sizeof($cursos) > 0)
            <x-bladewind::card>
                <form action="/planos/criar" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="flex items-center border border-slate-300 rounded">
                            ...
                            <input type="number" name="duracao" min="1" max="12" class="{{ $class_input }}" required 
                                placeholder="4 (meses)">
                        </div>
                    </div>
